...
import { meta, Content } from "@/content/blog/security-headers-guide";
      ...
      <main className="flex-1">
        <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <nav className="text-xs text-dracula-comment mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-foreground">Security Headers Guide</span>
          </nav>
          ...
          <header className="mb-8">
            ...
            {meta.relatedTool && (
              ...
              >
                Try the Header Security Analyzer
              </Link>
            )}
          </header>
