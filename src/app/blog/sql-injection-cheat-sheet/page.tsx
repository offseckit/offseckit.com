...
import { meta, Content } from "@/content/blog/sql-injection-cheat-sheet";
      ...
      <main className="flex-1">
        <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <nav className="text-xs text-dracula-comment mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-foreground">SQL Injection Cheat Sheet</span>
          </nav>
          ...
          <header className="mb-8">
            ...
            {meta.relatedTool && (
              ...
              >
                Try the SQLi Payload Generator
              </Link>
            )}
          </header>
